...
public class VariableIncomeRepository : IVariableIncomeWriteOnlyRepository, IVariableIncomeReadOnlyRepository
{
    ...
    {
        return await _context.VariableIncomes.AsNoTracking().ToListAsync();
    }
